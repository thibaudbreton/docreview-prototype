...
> SUPERSEDED by `docs/prompts/PROMPT-nightly-ticket-routine.md` on 2026-08-13. Kept for reference. Do not build from this — this version locates its ticket queue by the hardcoded filename `NIGHTLY-TICKETS.md`, which does not exist anywhere in this corpus; the revised version locates the queue by heading instead.
...
- `NIGHTLY-TICKETS.md` — the ticket queue this routine works from

## What to do, in order

1. **Read `NIGHTLY-TICKETS.md`.** Find the first ticket still marked `- [ ]` (unchecked), from top to bottom.
...
- Do not delete or rewrite `NIGHTLY-TICKETS.md` structure — only tick boxes, add summaries, and append blocker notes.

## At the end of the run

Update the **Run log** section at the top of `NIGHTLY-TICKETS.md`:
