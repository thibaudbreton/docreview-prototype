...
**What happens when the casting has nobody matching an activity** present in the document. This gap is a direct consequence of the reorganisation in 1.1 — the model has always assumed casting covers every activity in the document, and this is the first sign it won't. **No answer yet; needs a session with more experts.**
