...
| DEC-063 | **Charte** : **Noto Sans** pour tout le texte, **Antarctica** pour les titres ; le **bleu marine terne #0B294A** de la marque devient la couleur d'accent (le #0050E3 était apprécié mais la marque l'utilise peu) ; des **touches de rouge décoratives** sont bienvenues tant qu'elles ne brouillent pas l'UX — appliquées au point du logo et à une marque devant les titres de page, **jamais sur un élément cliquable ou porteur d'état**, le rouge signifiant déjà « non conforme ». Antarctica n'est sur aucun CDN et n'est pas installée : fichiers à fournir (voir `fonts/README.md`). **Le rouge exact de la marque reste à confirmer** (placeholder #E4002B) | Retour des parties prenantes, 22 septembre 2026 |
