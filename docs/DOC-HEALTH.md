...
- Last run: 2026-09-08T00:00Z (covered commits from `31eb00a` through
  `6221a15`, i.e. one substantive commit: `7f50eda`)
- Findings this run:
...
- Baseline for the next run: commits after `6221a15` (2026-09-08T16:54+02:00
  / 14:54Z), and #12 (still open, 2026-08-30) plus #15 (still open,
  2026-09-07) and PR #14 (still open, conflicting) — check whether any
